export default {
  ...
  toolbar: {
    exportPdf: 'Save as PDF (system print)',
  ...
  settings: {
    tabAbout: 'About',
    aboutDescription: 'Markdown documents with text and images together in one .mdoc file.',
    about: 'About MarkDoc',
    ...
    defaultTemplate: 'Everyday',
    defaultTemplateDesc: '10.5pt sans-serif body, compact headings, 1.6 line spacing',
  ...
  export: {
    dailyTemplate: 'Everyday',
    dailyTemplateDesc: '10.5pt sans-serif body, compact headings, 1.6 line spacing',
    formalTemplate: 'Formal document',
    formalTemplateDesc: 'Song body text, bold headings, traditional document styling',
    ...
    defaultTemplate: 'Everyday',
    defaultTemplateDesc: 'Matches the default editor style: compact headings and 10.5pt body text',
    customTemplate: 'Custom Template',
