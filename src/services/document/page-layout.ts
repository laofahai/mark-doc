...
export function buildPrintPageCss(value: unknown) {
  ...
  return [
    ...
    // Unwrap the desktop layout chain while retaining the live editor and its resources.
    '  html[data-markdoc-printing="true"] body *:not(:has([data-markdoc-print-root])):not([data-markdoc-print-root]):not([data-markdoc-print-root] *) { display: none !important; }',
    '  html[data-markdoc-printing="true"] body, html[data-markdoc-printing="true"] body *:has([data-markdoc-print-root]), html[data-markdoc-printing="true"] [data-markdoc-print-root] { display: block !important; position: static !important; width: auto !important; height: auto !important; min-width: 0 !important; min-height: 0 !important; max-width: none !important; max-height: none !important; margin: 0 !important; padding: 0 !important; border: 0 !important; overflow: visible !important; transform: none !important; contain: none !important; }',
    '  html[data-markdoc-printing="true"] [data-markdoc-print-hidden] { display: none !important; }',
    '  html[data-markdoc-printing="true"] [data-markdoc-print-root] { --background: #fff; --foreground: #111; --muted: #f3f4f6; --muted-foreground: #555; --border: #d1d5db; color-scheme: light; }',
    ...
    '  html[data-markdoc-printing="true"] .markdoc-tiptap-editor, html[data-markdoc-printing="true"] .markdoc-tiptap-editor > div { display: block !important; width: 100% !important; min-width: 0 !important; min-height: 0 !important; max-width: none !important; zoom: 1 !important; }',
    '  html[data-markdoc-printing="true"] .ProseMirror { display: flow-root !important; }',
